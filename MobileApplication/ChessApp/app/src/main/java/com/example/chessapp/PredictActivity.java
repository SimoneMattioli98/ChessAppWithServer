...
public class PredictActivity extends AppCompatActivity {
    ...
    private List<Bitmap> croppedImages = new ArrayList<>();
    ...
    private final String labelPath = "full_labels.txt";
    private final String modelPath = "mobilenetv2.tflite";
    private Activity activity;

    //------------------------------------------------------------------
    private final String URL = " https://a3bff2589060.ngrok.io/";
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        findViewById(R.id.loadingPanel).setVisibility(View.GONE);
                        VirtualBoardActivity.cropped_images = croppedImages;
